            ...
            <div class="widget-item">
              <div class="about-widget-wrap">
                <div class="widget-logo-area">
                  <a href="index.html">
                    <!--
                    <img class="logo-main" src="{{asset('frontend/assets/img/logo-light.webp')}}" width="131" height="34" alt="Logo" />
                    -->
                    Logo Here
                  </a>
                </div>
      ...
      <div class="container pt--0 pb--0">
        <div class="row">
          <div class="col-md-7 col-lg-6">
            <p class="copyright">© 2022 Sneakers. Made with <i class="fa fa-heart"></i> by <a target="_blank" href="https://codewithpranta.com">Codewithpranta.</a></p>
          </div>
          <div class="col-md-5 col-lg-6">
            <div class="payment">
              <a href="account-login.html"><img src="{{asset('frontend/assets/img/photos/payment-card.webp')}}" width="192" height="21" alt="Payment Logo"></a>
            </div>
          </div>
        </div>
      </div>
